...
const scriptCommand = require('./commands/script'); // Add the new script command
...
const initialSession = () => ({
  ...
  scriptSession: null, // Stores state for the /script command
});
...
bot.use(scriptCommand); // Handles custom script creation
